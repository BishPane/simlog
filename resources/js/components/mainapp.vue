      ...
      <div class="_1side_menu" >
        ...
        <div class="_1side_menu_content">
          ...
          <div class="_1side_menu_list">
            <ul class="_1side_menu_list_ul">
             <li v-for="(menuItem , i) in permission" :key="i" v-if="menuItem.read" >
                ...
                <router-link :to="menuItem.name"> <Icon type="ios-speedometer" /> {{menuItem.resourceName}}
                </router-link>
          ...
          <!-- <li><router-link to="home"> <Icon type="ios-speedometer" /> Home</router-link> </li>
                ...
                <li><router-link to="assignPermission"> <Icon type="ios-speedometer" /> Permissions</router-link> </li>
                <li><router-link to="lists"> <Icon type="ios-speedometer" /> Lists</router-link> </li>
                  <li><router-link to="posts"> <Icon type="ios-speedometer" /> Posts</router-link> </li>  -->
...
export default {
  ...
  created() {
     this.$store.commit('setUpdateUser',this.user)
      // console.log('User value if logged in ',this.user);
      //   console.log(' recieved Value from store ',this.$store.state.user);
